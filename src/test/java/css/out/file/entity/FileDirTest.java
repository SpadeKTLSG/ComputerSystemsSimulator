...
//        FCB f = new FCB("/home", ROOT_DIR_BLOCK, FILE);
        file file1 = new file(new FCB("/home", 114, FILE_EXTEND.get(0), FILE, FILE_LENGTH_DEFAULT + FCB_BYTE_LENGTH + setFileContextLength("114514")), "114514");
        dir dir1 = new dir(new FCB("/home", ROOT_DIR_BLOCK, DIR_EXTEND.get(0), DIR, DIR_LENGTH_DEFAULT + FCB_BYTE_LENGTH));

        //转换操作
        byte[] byte_temp = file1.toBytes();
        file temp_file = new file();
        temp_file.fromBytes(byte_temp);
